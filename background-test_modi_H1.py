...
output1 = "H1_kstest.png" #ksテスト
output2 = "H1_chi2test.png" #アウトプットのファイル
output3 = "H1_adtest.png" #adテスト
...
data_H1 = TimeSeries.read("H-H1_GWOSC_4KHZ_R1-1239080215-4096.hdf5", end = 1239080215 + duration_time,format="hdf5.gwosc") #gwoscからデータを入れておいてください!
...
A2_null = build_ad_null_distribution(N_tiles, n_sim=int(1e+8))
...
plt.savefig("pvalue_hist_H1.png")
