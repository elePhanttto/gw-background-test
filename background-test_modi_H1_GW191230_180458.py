...
data_H1 = TimeSeries.read("hdf5/H-H1_GWOSC_4KHZ_R1-1261762269-4096.hdf5",format="hdf5.gwosc") #gwoscからデータを入れておいてください!
...
axes[0].set_xlabel("Time from GW191230_180458 geocent time [s]")
...
axes[1].set_xlabel("Time from GW191230_180458 geocent time [s]")
