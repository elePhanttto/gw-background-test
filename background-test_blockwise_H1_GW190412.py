...
output1 = event + "blockwise_kstest_H1_block.png"
output2 = event + "blockwise_chi2test_H1_block.png"
output3 = event + "blockwise_adtest_H1_block.png"
output4 = event + "blockwise_pvalue_hist_H1_block.png"
output5 = event + "blockwise_dist_check_H1_block.png"
output6 = event + "blockwise_ratio_H1_block.txt"
output7 = event + "blockwise_tile_energy_H1_block.png"
output8 = event + "blockwise_a2_H1_block.png"
...
data_H1 = TimeSeries.read(
    "hdf5/H-H1_GWOSC_4KHZ_R1-1239080215-4096.hdf5",
    format="hdf5.gwosc",
)
...
invalid = np.isnan(data_H1.value)
...
data_t0 = data_H1.t0.value
data_t_end = (
    data_H1.t0.value
    + data_H1.duration.value
)
...
plt.xlabel(
    "Time from GW190412 geocent time [s]"
)
